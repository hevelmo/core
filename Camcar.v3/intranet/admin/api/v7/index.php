...
$app->get('/get/categorias/agencias/:agnId', /*'mws',*/ 'getCategoriasByAgenciaId');
...
$app->get('/get/marcas/agencias/:agnId', /*'mws',*/ 'getMarcasByAgenciaId');
$app->get('/get/modelos', /*'mws',*/ 'getModelos');
$app->get('/get/modelos/:mdoId', /*'mws',*/ 'getModelosById');
$app->get('/get/modelos/agencias/:agnId', /*'mws',*/ 'getModelosByAgenciaId');
...
function getCategoriasByAgenciaId($agnId) {
    $sql = "SELECT *
            FROM v_camSeminuevos
            WHERE AGN_Id = :agnId
            GROUP BY CAT_Id
...
function getMarcasByAgenciaId($agnId) {
    $sql = "SELECT *
            FROM v_camSeminuevos
            WHERE AGN_Id = :agnId
            GROUP BY MAR_Id
...
function getModelosArray($sql, $mdoId, $agnId) {
    $structure = array(
        'id' => 'MDO_Id',
        'nombre' => 'MDO_Nombre'
    );
...
function getModelosJSON($sql, $mdoId, $agnId) {
    $result = getModelosArray($sql, $mdoId, $agnId);
    echo changeArrayIntoJSON('camadpa', $result);
}
...
function getModelosByAgenciaId($agnId) {
    $sql = "SELECT *
            FROM v_camSeminuevos
            WHERE AGN_Id = :agnId
            GROUP BY MDO_Id
