...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/img/seminuevos/' . $_REQUEST['sen_id'] . '/',
            'upload_url' => $this->get_full_url().'/img/seminuevos/' . $_REQUEST['sen_id'] . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            // the redirect parameter, e.g. '/img/seminuevos/' . $_REQUEST['sen_id'] . '/'.
