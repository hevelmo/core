...
$app->get('/webservice/get/empleados/agencias/:agencia', /*'mws',*/ 'getWSEmpleadosByAgencia');
$app->get('/webservice/get/empleados/aniversarios/:aniversario', /*'mws',*/ 'getWSEmpleadosByAniversario');
$app->get('/webservice/get/empleados/apellidos_maternos/:apellido_materno', /*'mws',*/ 'getWSEmpleadosByApellidoMaterno');
$app->get('/webservice/get/empleados/apellidos_paternos/:apellido_paterno', /*'mws',*/ 'getWSEmpleadosByApellidoPaterno');
$app->get('/webservice/get/empleados/areas/:area', /*'mws',*/ 'getWSEmpleadosByArea');
$app->get('/webservice/get/empleados/cargos/:cargo', /*'mws',*/ 'getWSEmpleadosByCargo');
$app->get('/webservice/get/empleados/ciudades/:ciudad', /*'mws',*/ 'getWSEmpleadosByCiudad');
$app->get('/webservice/get/empleados/correos/:correo', /*'mws',*/ 'getWSEmpleadosByCorreo');
$app->get('/webservice/get/empleados/cumpleanos/:fecha', /*'mws',*/ 'getWSEmpleadosByCumpleanos');
$app->get('/webservice/get/empleados/edades/:edad', /*'mws',*/ 'getWSEmpleadosByEdad');
$app->get('/webservice/get/empleados/estados/:estado', /*'mws',*/ 'getWSEmpleadosByEstado');
$app->get('/webservice/get/empleados/fechas_ingreso/:fecha', /*'mws',*/ 'getWSEmpleadosByFechaIngreso');
$app->get('/webservice/get/empleados/marcas/:marca', /*'mws',*/ 'getWSEmpleadosByMarca');
$app->get('/webservice/get/empleados/numeros_agencia/:no_agencia', /*'mws',*/ 'getWSEmpleadosByNoAgencia');
$app->get('/webservice/get/empleados/numeros_empleado/:no_empleado', /*'mws',*/ 'getWSEmpleadosByNoEmpleado');
$app->get('/webservice/get/empleados/nombres/:nombres', /*'mws',*/ 'getWSEmpleadosByNombres');
$app->get('/webservice/get/empleados/telefonos/:telefono', /*'mws',*/ 'getWSEmpleadosByTelefono');
