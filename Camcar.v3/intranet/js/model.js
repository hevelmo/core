/*
    ...
    model and its arguments, for example CAMIN.momentToHuman(date, language);
    Each method has a large explanation.

    NOTE: the prefix CAMIN will change depends on the specific Project.
        ...
        function roundNDecimalFormat(number, nDecimals) {
            ...
            if(!isNaN(number)) {
                ...
                if(numberParts.length === 2) {
                    ...
                    //Now this new decimal part is converted to a string
