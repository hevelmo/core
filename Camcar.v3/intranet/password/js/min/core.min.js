...
;var CAMIN={};CAMIN=function(){function e(e,n){return moment.lang(n),moment(e).format("dddd[,] LL")}function n(e,n){return moment.lang(n),moment(e,"YYYY-MM-DD hh:mm:ss").fromNow(!0)}function a(e,n){var a=Handlebars.templates[e];return n?a(n):a}function t(e,n,t){$(n).html(a(e,t))}function i(e){return $(e).val()}function s(e,n){$(e).val(n)}function o(e){return $(e).length>0?!0:!1}function l(e){var n,a;n=$(e).val(),a=$.trim(n),$(e).val(a)}function r(e){return $(e).html()}function c(e,n){$(e).html(n)}function d(e){var n,a;n=$(e).val(),a=hex_sha512(n),$(e).val(a)}function m(e,n,a,t,i){var s;s="<"+n;for(var o in a)s+=a.hasOwnProperty(o)?" "+o+"='"+a[o]+"'":"";i?(s+=">",s+=t,s+="</"+n+">"):(s+=" />",s+=t),$(e).append(s)}function u(e,n){for(var a=0;a<n.length;a++)m(e,n[a][0],n[a][1],n[a][2],n[a][3])}function p(e,n,a,t,i){var s;s="<"+n;for(var o in a)s+=a.hasOwnProperty(o)?" "+o+"='"+a[o]+"'":"";i?(s+=">",s+=t,s+="</"+n+">"):(s+=" />",s+=t),$(e).prepend(s)}function g(e,n){for(var a=0;a<n.length;a++)p(e,n[a][0],n[a][1],n[a][2],n[a][3])}function v(e){var n,a,t,i,s,o,l,r,c,d,m,u,p,_,g,v,f;$(e).each(function(){n=$(this),a=$(n).val(),a=$.trim(a),t=a.length,i=n.css("font-size"),i=I(i,"px",""),i=+i,s=n.css("font-family"),o=n.css("width"),o=I(o,"px",""),o=+o,height=n.css("height"),l=n.css("padding-top"),l=I(l,"px",""),l=+l,r=n.css("padding-bottom"),r=I(r,"px",""),r=+l,c=n.css("line-height"),c=I(c,"px",""),c=+c,d=n.css("padding-left"),d=I(d,"px",""),d=+d,m=n.css("padding-right"),m=I(m,"px",""),m=+m,u=document.createElement("canvas"),p=u.getContext("2d"),p.font=i+"px"+s,_=p.measureText(a).width,_=Math.ceil(_),g=o-d-m,f=height,t&&_>g&&(v=_/g,v=Math.ceil(v),f=l+v*i+(v-1)*c+r,f+="px"),n.css("word-break","break-word"),n.css("height",f),n.css("vertical-align","middle")})}function f(e,n,a){var t,i,s,o,l,r;switch(t=new Date,i=new Date(t),i.setDate(t.getDate()+n),s=i.getFullYear(),o=+i.getMonth(),o+=1,l=i.getDate(),r=s+"-"+o+"-"+(+l+1),$(e).datetimepicker({pickTime:!1}),a){case 0:$(e).data("DateTimePicker").setDate(r);break;case 1:$(e).data("DateTimePicker").setMinDate(i),$(e).data("DateTimePicker").setDate(r);break;case 2:$(e).data("DateTimePicker").setMinDate(i)}}function h(e,n){var a;for(var t in e)e[t]=$.trim(e[t]);return a=_.size(_.compact(_.pick(e,n))),a===n.length?!0:!1}function b(e,n){var a;for(var t in e)e[t]=$.trim(e[t]);return a=_.size(_.compact(_.pick(e,n))),a?!1:!0}function y(e){$(e).each(function(){this.reset()})}function w(e,n){return $.ajax({type:"POST",contentType:"application/json",url:e,dataType:"json",data:JSON.stringify(n)})}function A(e){var n;return n=function(){var n=null;return $.ajax({async:!1,global:!1,url:e,dataType:"json"}).done(function(e){n=e}),n}()}function M(e,n){return"object"==typeof e?e.hasOwnProperty(n):!1}function k(e,n,a,t){return _.filter(_.pluck(e,n),function(e){return t?e===a:e!==a})}function E(e,n){return _.reduce(_.pluck(e,n),function(e,n){return+e+ +n})}function S(e,n){var a,t;a=[],t=_.pairs(n);for(var i=0;i<e.length;i++)for(a[i]={},j=0;j<t.length;j++)a[i][t[j][0]]=e[i][t[j][1]];return a}function x(e,n){var a,t;do a=e.length,e=_.without(e,_.findWhere(e,n)),t=e.length;while(a!==t);return e}function C(e,n){pairs=_.pairs(n),withoutArrayObj=[];for(var a=0;a<pairs.length;a++)withoutArrayObj[a]=new Object,withoutArrayObj[a][pairs[a][0]]=pairs[a][1];for(a=0;a<withoutArrayObj.length;a++)e=x(e,withoutArrayObj[a]);return e}function T(e){var n;return n=accounting.formatMoney(e)}function N(e,n){var a,t,i,s,o,l;if(l=NaN,!isNaN(e)){if(e=""+e,a=e.split("."),t=a[0],i="0",2===a.length)for(i=a[1],o=Math.pow(10,i.length-n),s=+i/o,i=Math.ceil(s),i=""+i,idx=0;idx<n-i.length;idx++)i="0"+i;l=t+"."+i,l=+l,l=l.toFixed(n)}return l}function I(e,n,a){return e=""+e,expReg=new RegExp(n,"g"),e.replace(expReg,a)}function D(e){var n,a,t,i;for(n=e.split(" "),t=n.length,a="",i=0;t>i;i++)i!=t-1?a=a+L(n[i])+" ":a+=L(n[i]);return a}function L(e){return e.substr(0,1).toUpperCase()+e.substr(1,e.length).toLowerCase()}function O(e){var n,a;return n=$.trim(e),a=n.split(" "),a=_.without(a,""),n=a.join(" "),n=$.trim(n)}function B(e,n,a,t){"use strict";$(e).fileupload({url:a,dataType:"json",done:function(e,n){var a,i;i=n.result.files,a=w(t,i),a.success(function(){$.each(i,function(e,n){$("<p/>").text(n.name).appendTo("#files")})})},progressall:function(e,a){var t=parseInt(a.loaded/a.total*100,10);$(n).css("width",t+"%","background-color","#5cb85c")}})}function P(e){for(var n="0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz",a=4,t="",i=0;a>i;i++){var s=Math.floor(Math.random()*n.length);t+=n.substring(s,s+1)}$(e).val(t)}return moment.lang("es",{months:"Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split("_"),monthsShort:"ene._feb._mar_abr._may_jun_jul._ago_sep._oct._nov._dic.".split("_"),weekdays:"Domingo_Lunes_Martes_Miércoles_Jueves_Viernes_Sábado".split("_"),weekdaysShort:"dom._lun._mar._mier._juev._vie._sab.".split("_"),weekdaysMin:"Do_Lu_Ma_Mi_Ju_Vi_Sa".split("_"),longDateFormat:{LT:"HH:mm",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY LT",LLLL:"dddd D MMMM YYYY LT"},calendar:{sameDay:"[Hoy a las] LT",nextDay:"[Mañanaalas]LT",nextWeek:"dddd[a]LT",lastDay:"[Ayera]LT",lastWeek:"dddd[hasta]LT",sameElse:"L"},relativeTime:{future:"en %s",past:"hace %s",s:"unos segundos",m:"un minuto",mm:"%d minutos",h:"una hora",hh:"%d horas",d:"un día",dd:"%d dias",M:"un mes",MM:"%d meses",y:"un año",yy:"%d años"},ordinal:function(e){returnnumber+(1===e?"er":"a")},week:{dow:1,doy:6}}),{momentToRoman:e,momentToHuman:n,getTemplate:a,loadTemplate:t,getValue:i,setValue:s,existInDOM:o,trimValue:l,getHTML:r,setHTML:c,cryptElement:d,appendOne:m,appendMulti:u,prependOne:p,prependMulti:g,resizeInput:v,setDateTPCalendar:f,validFormFull:h,validFormEmpty:b,resetForm:y,postalService:w,getInternalJSON:A,hasOwnPropertyOptimized:M,filterArrayObjByKey:k,sumArrayObjByKey:E,renameArrayObjKeys:S,withoutArrayObjAND:x,withoutArrayObjOR:C,currencyFormat:T,roundNDecimalFormat:N,replaceAll:I,ucWords:D,ucFirst:L,advancedTrim:O,picturesLoader:B,randomString:P}}();
