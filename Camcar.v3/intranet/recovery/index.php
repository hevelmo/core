                ...
                <div id="carbonads">
                    <span>
                        <span class="carbon-wrap pb-10">
                            <strong class="carbon-wrap-title">¿Cómo recuperar tu contraseña?</strong>
                        </span>
            ...
            <div class="page-content vertical-align-middle">
                <div class="panel panel-shadow">
                    <div class="panel-body">
                        ...
                        <form onsubmit="$.submit_recovery_form(); return false;" id="process_recovery" class="recovery-form mtb-15">
                        <?php /* ?>
                        <form method="post" action="process_recovery.php" id="process_recovery" class="recovery-form mtb-15">
                        <?php */ ?>
                            <div class="form-group">
                                <fieldset>
                                    <label class="sr-only" for="inputEmail">Correo Electrónico</label>
                                    <input type="email"
                                        class="form-control camcar-remark-input input-recovery validate-required validate-email"
                                        id="inputEmail"
                                        name="email"
                                        placeholder="Usuario"
