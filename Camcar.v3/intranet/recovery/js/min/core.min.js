...
var $recovery_email,$btnSend;$recovery_email=$("#inputEmail"),$btnSend=$(".enviar.button.blue"),$.submit_recovery_form=function(){form_errors=0,$.validate_input($recovery_email)||(form_errors++,$("#inputEmail").focus(),swal({title:"Oops...",text:"Es necesario tu correo para crear una nueva contraseña",type:"error",timer:1500,showConfirmButton:!1})),0==form_errors&&setTimeout(function(){var e={email:$("#inputEmail").val()},n="process_recovery.php";$.ajax({cache:!1,data:e,dataType:"html",method:"POST",success:function(e){e?setTimeout(function(){swal({title:"Genial...",text:"Te hemos enviado un enlace para crear tu nueva contraseña a tu correo.",type:"success",showConfirmButton:!0}),setTimeout(function(){window.location="../login"},1250)},1200):setTimeout(function(){swal({title:"OoO!!!",text:"Ha ocurrido un error, por favor, Intentalo nuevamente",type:"error",showConfirmButton:!0})},1200)},error:function(){setTimeout(function(){swal({title:"Oops...",text:"Ha ocurrido un error, por favor, inténtalo nuevamente.",type:"error",showConfirmButton:!0})},1200)},url:n})},1e3)};

;$(document).ready(function(){$recovery_email.on("focusout",function(){$.validate_input($recovery_email)})});
