...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <title>CAMCAR Recuperar Contraseña</title>
                ...
                <div class="panel panel-shadow">
                    <div class="panel-body">
                        ...
                        <div class="welcome">
                            ...
                            <p class="pt-5 pb-0 m-0">Ingresa la que será tu nueva contraseña</p>
                        </div>
                        <form onsubmit="$.submit_recovery_password_form(); return false;" id="form-process-password" class="mt-10 mb-10 strength_password">
                        <?php /* ?>
                        ...
                        <?php */ ?>
                            <div class="form-group">
                                <fieldset>
                                    ...
                                    <input type="password" 
                                        class="form-control camcar-remark-input strength_password_pass input-password validate-required" 
                                        id="inputPassword" 
                                        name="password" 
                            ...
                            <div class="form-group">
                                <fieldset class="mb-0">
                                    ...
                                    <input type="password" 
                                        class="form-control camcar-remark-input input-password validate-required validate-password-confirm" 
