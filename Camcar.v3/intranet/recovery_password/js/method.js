...
/* ------------------------------------------------------ *\
    [onSubmit function] $.submit_recovery_password_form
\* ------------------------------------------------------ */
    $.submit_recovery_password_form = function() {
        form_errors = 0;
        ...
        if ( $password.val() != $conf_password.val() ) {
            ...
            if (form_errors == 0) {
                //setTimeout(function() {
                    //swal({   title: "Genial...",   text: 'Los datos son correctos...',   type: "success",   timer: 1500,   showConfirmButton: false });
                    setTimeout(function() {
                        var data = {
                        ...
                        var service_url = 'process_recovery_password.php';
                        $.ajax({
                            cache: false,
                            data: data,
                            dataType: 'html',
