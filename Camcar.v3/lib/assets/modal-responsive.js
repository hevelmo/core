...
(function ($, w, ns, da) {
    ...
    var $window = $(w),
        ...
        $modal = $("<div/>").addClass("modal-preview fade-out").appendTo($overlay),
    ...
    Modal.prototype.create = function () {
        ...
        var title = this.options.title,
            ...
            $content = $("<div id='modal-preview-info'/>").addClass("modal-content-preview");
        ...
        if (title || !modal) {
            ...
            if (title) {
                ...
                $header.html("<div class=\"container-preview\"><h2 id=\"" + id + "\">" + title + "</h2></div>")
                       .appendTo($overlay.attr({ "aria-labelledby": id }));
            }

            if (!modal) {
                $close.html("<i class='fa fa-close fa-fw fa-lg'></i> <span class=\"visuallyhidden\">" + this.options.closeHint + "</span>").appendTo($overlay);
            }
        }
        ...
        if (description) {
            ...
            $footer.html("<div class=\"container-preview\">" + description + "</div>")
                   .appendTo($overlay);
        }
        ...
        if (local) {
            ...
            $modal.addClass(this.options.fitViewport ? "container-preview" : "");
    ...
    Modal.prototype.destroy = function (noOverlay) {
        ...
        w.setTimeout(function () {
            $modal.removeClass("modal-iframe iframe-full modal-ajax modal-image container-preview").css({
                "max-height": "",
                "max-width": ""
            }).empty();
    ...
    Modal.prototype.resize = function () {
        ...
        if ($modal.hasClass("modal-image")) {
            ...
            var $content = $modal.children(".modal-content-preview");
