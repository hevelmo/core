		...
		********************************/
		...
		function setSize(img,opt) {
				...
				if (opt.fullScreen=="on") {
						...
						opt.container.css({'height':'780px'});
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first').css({overflow:'hidden',width:'100%',height:'780px',maxHeight:container.parent().css('maxHeight')});
			if (opt.autoHeight=="on") {
			   container.find('>ul:first').css({overflow:'hidden',width:'100%',height:'780px',maxHeight:"780px"});
			   container.css({'maxHeight':'780px'});
			   container.parent().css({'maxHeight':'780px'});
			 }
			...
			container.find('>ul:first >li').each(function(j) {
				...
				li.css({'width':'100%','height':'780px','overflow':'hidden'});
