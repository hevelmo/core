...
// SELECT
    ...
    // TYPE AGENCIE
    $app->get('/get/tipo/agencia/:agn_name_agencia', /*'mw1',*/ 'getAgenciesNewsByTypeAgencie');

    // BRANDS HOME
    $app->get('/get/logos', /*'mw1',*/ 'getBrandsLogos');
...
// SELECT
    ...
    function getAgenciesNewsByTypeAgencie($agn_name_agencia/*, $agn_type*/) {
        $sql = "SELECT *
                ...
                ON agn.AGN_AGP_Id = agp.AGP_Id
                WHERE AGP_Agencia = :agn_name_agencia
                AND AGN_Tipo = 1
                ";
        $params = array();
        $structure = array(
                                                    ...
                                                    <tr>
                                                        <td height="15" width="100">
                                                            ...
                                                            <p style="display: inline-block; color:#ffffff;font-family: ProximaNovaRegular,Montserrat, Helvetica Neue, Helvetica, Arial, sans-serif;font-size:24px;text-align:center;padding:0;text-transform: uppercase; margin-right: 0px; float: right;">
                                                                <img src="http://camcar.mx/resources/public/img/logos_agencias/'.$sem_con_sp_bm_logo_agencia.'" alt="Modelo" width="150">
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
