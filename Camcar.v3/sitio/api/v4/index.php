...
// SELECT
    ...
    function getSeminuevosJSON($sql, $mrc_nombre_short, $mdo_nombre_short, $senId){//, $category, $marca, $modelo
        $structure = array(
            ...
            'telefonos' => array(
                'agnTelefono1' => 'AGN_Telefono1',
                'agnTelefono2' => 'AGN_Telefono2'
            ),
            'llamanos' => array(
                'agnCall1' => 'AGN_Call1',
                'agnCall2' => 'AGN_Call2'
    ...
    function getAgenciesPreOwnedByAgencieJSON($sql, $agn_nombre, $agn_id) {
        $structure = array(
            ...
            'agnurl' => 'AGN_Url',
            'horarios' => array(
                'agnhrventas' => 'AGN_HVentas',
                'agnhrservicio' => 'AGN_HServicio',
                'agnhrrefaccion' => 'AGN_HRefacciones'
            ),
            'agnfolder' => 'AGN_Folder',
            'agnlogo' => 'AGN_Logo',
            'agnfachada' => 'AGN_Fachada',
            'agnsmall' => 'AGN_Small',
            'agnwebsite' => 'AGN_WebSite',
            'agnlatitud' => 'AGN_MLatitud',
            'agnlongitud' => 'AGN_MLongitud',
            'agngmapurl' => 'AGN_MUrl'
        );
    ...
    function getAgenciesNewsByAgencieJSON($sql, $agm_nombre, $agm_id) {
        $structure = array(
            ...
            'agmnombre' => 'AGM_Nombre',
            'agmdireccion' => 'AGM_Dirección',
            'agmtelefono' => 'AGM_Telefono',
            'agmcall' => 'AGM_Call',
            'agmurl' => 'AGM_Url',
            'horarios' => array(
                'agmhrventas' => 'AGM_HVentas',
                'agmhrservicio' => 'AGM_HServicio',
                'agmhrrefaccion' => 'AGM_HRefacciones',
            ),
            'agmfolder' => 'AGM_Folder',
            'logotipos' => array(
                'agmlogo1' => 'AGM_Logo1',
            ...
            'agmsmall' => 'AGM_Small',
            'sociales' => array(
                'agmwebsite' => 'AGM_WebSite',
                'agmface' => 'AGM_Facebook',
                'agmtwit' => 'AGM_Twitter',
            ),
            'mapas' => array(
                'agmlatitud' => 'AGM_MLatitud',
