...
// SELECT
    ...
    $app->get('/get/agencia/nuevos/mapas/:agm_id', /*'mw1',*/ 'getAgenciesNewsByMap');
    $app->get('/get/agencia/nuevos/:agm_nombre/:agm_id', /*'mw1',*/ 'getAgenciesNewsByAgencie');
...
// SELECT
    ...
    function getAgenciesNewsJSON($sql) {
        $structure = array(
            'agmid' => 'AGM_Id',
            'agmnombre' => 'AGM_Nombre',
            'agmurl' => 'AGM_Url',
            'agmitem' => 'AGM_Item',
            'agmsmall' => 'AGM_Small',
            'agmlatitud' => 'AGM_MLatitud',
            'agmlongitud' => 'AGM_MLongitud',
            'agmgmapurl' => 'AGM_MUrl'
        );
        $params = array();
        echo changeQueryIntoJSON('campa', $structure, getConnection(), $sql, $params, 0, PDO::FETCH_ASSOC);
    }
    function getAgenciesNewsByMapsJSON($sql, $agm_id) {
        $structure = array(
            'agmid' => 'AGM_Id',
            'agmnombre' => 'AGM_Nombre',
            'agmdireccion' => 'AGM_Dirección',
            'agmfolder' => 'AGM_Folder',
            'logo' => array(
                'agmlogo1' => 'AGM_Logo1',
                'agmlogo2' => 'AGM_Logo2'
            ),
        ...
        $params = array();
        ($agm_id !== '') ? $params['agm_id'] = $agm_id : $params = $params;
        echo changeQueryIntoJSON('campa', $structure, getConnection(), $sql, $params, 0, PDO::FETCH_ASSOC);
    }
    // Get Agencies News by Agencies
    function getAgenciesNewsByAgencieJSON($sql, $agm_nombre, $agm_id) {
        $structure = array(
            'agmid' => 'AGM_Id',
            'agmnombre' => 'AGM_Nombre',
            'agmdireccion' => 'AGM_Dirección',
            'agmtelefono' => 'TEL_Telefono',
            'agmcall' => 'TEL_Call',
            'agmurl' => 'AGM_Url',
            'horarios' => array(
                'agmhrventas' => 'HRS_HVentas',
                'agmhrservicio' => 'HRS_HServicio',
                'agmhrrefaccion' => 'HRS_HRefacciones'
            ),
            'agmfolder' => 'AGM_Folder',
            'logotipos' => array(
                'agmlogo1' => 'AGM_Logo1',
            ...
            'agmfachada' => 'AGM_Fachada',
            'agmsmall' => 'AGM_Small',
            'sociales' => array(
                'agmwebsite' => 'SOC_WebSite',
                'agmface' => 'SOC_Facebook',
                'agmtwit' => 'SOC_Twitter'
            ),
            'mapas' => array(
                'agmlatitud' => 'AGM_MLatitud',
        ...
        $params = array();
        ($agm_nombre !== '') ? $params['agm_nombre'] = $agm_nombre : $params = $params;
        ($agm_id !== '') ? $params['agm_id'] = $agm_id : $params = $params;
        echo changeQueryIntoJSON('campa', $structure, getConnection(), $sql, $params, 0, PDO::FETCH_ASSOC);
    }
    // CONSULTA
    ...
    function getSeminuevos() {
        $sql = "SELECT *
                ...
                INNER JOIN camAGNTelefonos agntel
                ON agn.AGN_Id = agntel.TEL_AGN_Id
    ...
    function getSeminuevosById($mrc_nombre_short, $mdo_nombre_short, $senId) {
        $sql = "SELECT *
                ...
                INNER JOIN camAGNTelefonos agntel
                ON agn.AGN_Id = agntel.TEL_AGN_Id
                INNER JOIN camAGNHorarios agnhrs
                ON agn.AGN_Id = agnhrs.HRS_AGN_Id
                INNER JOIN camAGNSociales agnsoc
                ON agn.AGN_Id = agnsoc.SOC_AGN_Id
                INNER JOIN camCategorias cat
                ON sen.SEN_CAT_Id = cat.CAT_Id
                INNER JOIN camModelos mdo
                ON sen.SEN_MDO_Id = mdo.MDO_Id
    ...
    function getAgenciesNews() {
        $sql = "SELECT *
                FROM camAgenciasNuevos agm
                ";
        getAgenciesNewsJSON($sql, '', '');
    }
    function getAgenciesNewsByMap($agm_id) {
        $sql = "SELECT *
                FROM camAgenciasNuevos agm
                WHERE AGM_Id = :agm_id
                ";
        getAgenciesNewsByMapsJSON($sql, $agm_id);
    }
    // AGENCIES NEWS BY AGENCIES
    function getAgenciesNewsByAgencie($agm_nombre, $agm_id) {
        $sql = "SELECT *
                FROM camAgenciasNuevos agm
                INNER JOIN camAGMTelefonos agmtel
                ON agm.AGM_Id = agmtel.TEL_AGM_Id
                INNER JOIN camAGMHorarios agmhrs
                ON agm.AGM_Id = agmhrs.HRS_AGM_Id
                INNER JOIN camAGMSociales agmsoc
                ON agm.AGM_Id = agmsoc.SOC_AGM_Id
                WHERE AGM_Id = :agm_id
                AND AGM_Url = :agm_nombre
                ORDER BY AGM_Id
                ";
        getAgenciesNewsByAgencieJSON($sql, $agm_nombre, $agm_id);
    }
